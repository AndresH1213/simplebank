...
import (
	...
	mockdb "github.com/AndresH1213/simplebank/db/mock"
	db "github.com/AndresH1213/simplebank/db/sqlc"
	"github.com/AndresH1213/simplebank/util"
...
func (e eqCreateUserParamsMatcher) String() string {
	return fmt.Sprintf("matches arg %v and password %v", e.arg, e.arg.HashedPassword)
}
...
func TestCreateUserAPI(t *testing.T) {
	...
	for i := range testCases {
		...
		request, err := http.NewRequest(http.MethodPost, "/users", bytes.NewBuffer(bodyBytes))
		require.NoError(t, err)
